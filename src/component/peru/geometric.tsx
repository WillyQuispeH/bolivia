        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-red-600 via-yellow-400 to-green-600",
                  pacifico.className
                )}
              >
                {title2}
          ...
          >
            <p className="text-[15px] sm:text-lg md:text-xl text-white mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              ¡Bolivia merece ser protagonista! Mira el reel, ubica el
              comentario BOLIVIA de Ibai y dale tu like. ¡Hagamos que todos
              conozcan nuestra cocina y cultura!
            </p>
